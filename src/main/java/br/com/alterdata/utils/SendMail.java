package br.com.alterdata.utils;
...
public class SendMail {
	...
	public void sendMail(String from, String to, String subject, String message) {
		...
		props.put("mail.smtp.user", "agendadorferias@gmail.com"); // usuario ou seja, a conta que esta enviando o email (tem que ser do GMAIL)
		 ...
		 * responsavel por solicitar e retornar o usuário e senha para autenticação
		 */
		...
		try {
			 ...
			 * gmail
			 */
			tr.connect(mailSMTPServer, "agendadorferias@gmail.com", "suasenha123");
